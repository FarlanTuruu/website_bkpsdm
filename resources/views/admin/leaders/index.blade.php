...
@section('content')
    <div class="bg-white rounded-xl shadow-lg p-4 sm:p-6">
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-6">
            <h3 class="text-lg sm:text-xl font-semibold text-gray-800">Manajemen Pimpinan</h3>
            <a href="{{ route('leaders.create') }}" class="inline-flex items-center justify-center bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition duration-200 w-full sm:w-auto">
            ...
            <table class="min-w-[650px] w-full bg-white">
                <thead>
                    <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                        <th class="py-3 px-4 sm:px-6 text-left">Foto</th>
                        <th class="py-3 px-4 sm:px-6 text-left">Nama</th>
                        <th class="py-3 px-4 sm:px-6 text-left">Jabatan</th>
